...
var callApi = function (endpoint, bearer, callback) {
    console.log('calling ' + endpoint + ' ' + bearer)
    var request_details = {
        method: 'GET',
        headers: {'Accept': '*\/*',
            ...
            _.each(items, function (item) {
                ...
                if (lastI && lastI.route !== item.route) {
                    ...
                    _.each(itemContainer, function (ic) {
                        ...
                        ic.average = mediaCalc.map(function (x, i, arr) {
                            return x / arr.length
                        }).reduce(function (a, b) {
                            return a + b
                        });
